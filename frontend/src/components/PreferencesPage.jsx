        ...
        <div style={{
            ...
            <style>{`
                ...
                * { box-sizing: border-box; }
                .pref-card { background: rgba(15,23,42,0.8); border: 1px solid rgba(56,189,248,0.12); border-radius: 20px; padding: 2rem; backdrop-filter: blur(16px); }
                ...
                .btn-save { background: linear-gradient(135deg,#0EA5E9,#6366F1); color:#fff; border:none; padding:1rem 2.5rem; border-radius:12px; font-size:1rem; font-weight:600; cursor:pointer; transition:all 0.2s; font-family:inherit; margin-top: 2rem; width: 100%; box-shadow: 0 4px 15px rgba(99,102,241,0.2); }
                ...
                select.pref-input { background: rgba(6,13,31,0.8); border: 1px solid rgba(56,189,248,0.2); border-radius: 8px; padding: 0.5rem; color: #F1F5F9; font-family: inherit; outline: none; }
            `}</style>
                ...
                <div className="pref-card">
                    ...
                    <div className="pref-row">
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                            <input type="range" min="5" max="120" value={prefs.refreshRate} onChange={e => setPrefs({ ...prefs, refreshRate: parseInt(e.target.value) })} style={{ width: "120px", accentColor: "#0EA5E9" }} />
                            <span style={{ color: "#38BDF8", fontWeight: 700, width: "30px" }}>{prefs.refreshRate}s</span>
                        </div>
                    </div>
